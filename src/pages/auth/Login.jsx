...
import { getRedirectPath, getLandingPath } from '../../utils/constants'
      ...
      <Card sx={{ width: '100%', maxWidth: 440, borderRadius: 3 }} elevation={4}>
        <CardContent sx={{ p: 4 }}>
          <Box sx={{ textAlign: 'center', mb: 3 }}>
            <Box component="img" src="/logo.png" alt="logo" sx={{ height: 80, mx: 'auto', display: 'block', objectFit: 'contain', mb: 1.5 }} />
